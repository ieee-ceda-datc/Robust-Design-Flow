...
pwrDown_RVT = str(design_details[5])
pwrDown_LVT = str(design_details[6])
pwrDown_SLVT = str(design_details[7])
constDown_RVT = str(design_details[8])
constDown_LVT = str(design_details[9])
constDown_SLVT = str(design_details[10])
pinCapDown_RVT = str(design_details[11])
pinCapDown_LVT = str(design_details[12])
pinCapDown_SLVT = str(design_details[13])
...
if flag:
    ...
    for line in contents:
        ...
        if (items[0] == 'postRouteOpt'):
            ...
            worst_neg_slack_ns = round(float(items[-4]),3)
            worst_neg_slack = worst_neg_slack_ns * 1000
        else:
            pass
